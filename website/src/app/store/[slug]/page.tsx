...
const products: Record<string, {
  ...
  "logo-tee": {
    ...
    slug: "logo-tee",
    price: 3200,
    description: "The official Atomic Tawk logo tee. Made from heavy-duty cotton for maximum durability in the shed or on the track.",
    specs: [
      { label: "Composition", value: "100% Heavy Cotton" },
      { label: "Mass Index", value: "240 GSM" },
      { label: "Fit Profile", value: "Industrial Oversized" },
      { label: "Maintenance", value: "Cold Cycle / No Heat" },
    ],
  ...
  "mechanical-cap": {
    ...
    slug: "mechanical-cap",
    price: 2800,
    description: "Standard issue headwear for certified mechanical operators. Adjustable strap for all head sizes.",
    specs: [
      { label: "Material", value: "Cotton Twill" },
      { label: "Closure", value: "Adjustable Strap" },
      { label: "Style", value: "Structured Crown" },
    ],
  ...
  "shed-poster": {
    ...
    slug: "shed-poster",
    price: 2000,
    description: "Vintage-style propaganda poster celebrating the noble art of shed work. Perfect for your workshop or man cave.",
    specs: [
      { label: "Size", value: "18x24 inches" },
      { label: "Paper", value: "Premium Matte" },
      { label: "Print", value: "Archival Quality" },
    ],
    images: ["https://images.unsplash.com/photo-1561839561-b13bcfe95249?w=800&q=80"],
    category: "poster",
    serialNo: "AT-PRNT-09",
    inStock: true,
  },
...
export default function ProductPage({ params }: Props) {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#E3E2D5] flex items-center justify-center">
          ...
          <div className="w-full lg:w-3/5 industrial-border bg-white relative p-6">
            ...
            <div className="relative w-full aspect-square bg-[#f8f8f8] border-2 border-[#353535]/10 overflow-hidden flex items-center justify-center">
              ...
              <div className="absolute bottom-10 right-10 font-mono text-[11px] font-black text-[#353535]/40 text-right">
                COORD_SYS: 45.32.X<br />UNIT: {product.serialNo}
              </div>
          ...
          <div className="w-full lg:w-2/5 flex flex-col gap-8">
            ...
            <div className="industrial-border bg-[#E3E2D5] p-5 flex items-center gap-4">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.15em]">
                Logistics: {product.inStock ? "Depot In Stock // Ready for Deployment" : "Out of Stock"}
              </span>
            </div>
          </div>
        </div>
