...
import { Radio, Mail, MapPin, Phone, Send, Check } from "lucide-react";
      ...
      <section className="bg-[#CCAA4C] border-b-8 border-[#353535] py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          ...
          <p className="text-lg text-[#353535]/80 max-w-xl mt-4">
            ...
            Open a communication channel with Atomic Tawk HQ.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-5 space-y-8">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="font-bold">hello@atomictawk.com</span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="font-bold">104.2 FM</span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="font-bold">The Shed, Australia</span>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="industrial-border bg-white p-8 relative">
              ...
              <p className="text-sm text-[#353535]/70 mb-6">
                Subscribe to receive weekly mechanical updates, shed tips, and exclusive content.
              </p>
              ...
              <div className="flex justify-center gap-4">
                {["YouTube", "Instagram", "TikTok", "X"].map((platform) => (
                  <a
                    key={platform}
                    href="#"
                    className="w-12 h-12 border-2 border-[#353535] flex items-center justify-center hover:bg-[#CCAA4C] transition-colors font-black text-xs"
                  >
                    {platform.charAt(0)}
                  </a>
                ))}
